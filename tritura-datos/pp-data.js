...
ppFavor = _.filter(mociones, function(res) { if (/PP/.test(res.a_favor)) return res.fecha });
...
ppContra = _.filter(mociones, function(res) { if (/PP/.test(res.en_contra)) return res.fecha });
...
ppAbstencion = _.filter(mociones, function(res) { if (/PP/.test(res.abstencion)) return res.fecha });
