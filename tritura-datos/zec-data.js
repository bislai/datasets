...
zecFavor = _.filter(mociones, function(res) { if (/ZEC/.test(res.a_favor)) return res.fecha });
...
zecContra = _.filter(mociones, function(res) { if (/ZEC/.test(res.en_contra)) return res.fecha });
...
zecAbstencion = _.filter(mociones, function(res) { if (/ZEC/.test(res.abstencion)) return res.fecha });
